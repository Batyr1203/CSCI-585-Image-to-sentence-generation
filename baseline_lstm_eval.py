...
# Parameters
data_folder = '/workspace/datasets/COCO_2014/out/'  # folder with data files saved by create_input_files.py
data_name = 'coco_5_cap_per_img_5_min_word_freq'  # base name shared by data files
checkpoint = 'checkpoints/BEST_checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'  # model checkpoint
word_map_file = 'checkpoints/WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
...
def evaluate(beam_size):
    ...
    bleu4 = corpus_bleu(references, hypotheses)   # default weights (0.25, 0.25, 0.25, 0.25) correspond to BLEU-4
